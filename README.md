...
integrated with **Python** through **PySpark**.
- Storing processed data using both **NoSQL** and **Relational** Databases (**MongoDB** + **PostgreSQL**)
- Designing and executing analytical queries using **SQL**
